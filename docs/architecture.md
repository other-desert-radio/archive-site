...
active category. `src/pages/djs/[id].astro` generates one static detail page
per DJ in `public/archive/djs_brief.json`; it currently renders a minimal
placeholder while the profile UI is built.
